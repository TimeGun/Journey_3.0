...
public class SceneSetupSaver
{
    ...
    {
        var loader = ScriptableObject.CreateInstance<SceneSetupSciptableObject>();

        loader.sceneSetups = EditorSceneManager.GetSceneManagerSetup();
    ...
    public static void RestoreSceneSetup()
    {
        ...
        var loader = AssetDatabase.LoadAssetAtPath<SceneSetupSciptableObject>(assetPath);

        EditorSceneManager.RestoreSceneManagerSetup(loader.sceneSetups);
