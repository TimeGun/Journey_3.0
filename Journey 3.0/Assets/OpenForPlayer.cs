...
public class OpenForPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < _activationDistance)
        {
            ...
            float tempHoverDistance = Map(distanceToPlayer, _activationDistance, 0, 0, _hoverDistance);
        ...
        else
        {
            ...
            _topRunePart.transform.position = Vector3.MoveTowards(_topRunePart.transform.position, _closedRunePosition, Time.deltaTime * _lerpSpeed * 2f);
        }
    }
